package ru.mirea.inbo0220.markaryants.pr27;
...
public class Test implements Runnable {
    ...
    private void resize(int i) {
        int cores = Runtime.getRuntime().availableProcessors();
        String srcFolder = "src/ru/mirea/inbo0220/markaryants/pr27/images";
        String dstFolder = "src/ru/mirea/inbo0220/markaryants/pr27/new_images";
